...
class Profile extends StatefulWidget {
  ...
  Users userInfo;
  Profile(this.userInfo, this.all_user);

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return ProfileState(userInfo, all_user);
  }
...
class ProfileState extends State<Profile> {
  ...
  List<Users> all_user = new List();
  Users userInfo;
  ProfileState(this.userInfo, this.all_user);
        ...
        if (_formKey.currentState.validate()) {
          if (new_pass.text == "" ||
            ...
            _scaffoldKey.currentState.showSnackBar(new SnackBar(
              content: Text("Please fill up data"),
            ));
            ...
            udUser.setUsers(userInfo.id, useridcontrol.text, usernamecontrol.text, agecontrol.text, new_pass.text, quotecontrol.text);
              ...
              buttons: [
                DialogButton(
                  ...
                  onPressed: (){
                    ...
                    MaterialPageRoute(
                      builder: (context) => Home(udUser, items)
                    ));
                  },
                  width: 120,
                )
